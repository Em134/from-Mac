...
public class ActivityResult20 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wenzhen_result20);       //上火
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                values.clear();
                Intent intent = null;
                intent = new Intent(ActivityResult20.this, MainActivity.class);
