...
public class ActivityHeartResult3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wenzhen_heart_result3);  //结核病
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                values.clear();
                Intent intent = null;
                intent = new Intent(ActivityHeartResult3.this, MainActivity.class);
