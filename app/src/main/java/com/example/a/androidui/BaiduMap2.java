...
import com.example.a.androidui.overlayutil.BikingRouteOverlay;
import com.example.a.androidui.overlayutil.DrivingRouteOverlay;
import com.example.a.androidui.overlayutil.OverlayManager;
import com.example.a.androidui.overlayutil.TransitRouteOverlay;
import com.example.a.androidui.overlayutil.WalkingRouteOverlay;

/**
 * 此demo用来展示如何进行驾车、步行、公交路线搜索并在地图使用RouteOverlay、TransitOverlay绘制
 * 同时展示如何进行节点浏览并弹出泡泡
 */
public class BaiduMap2 extends Activity implements BaiduMap.OnMapClickListener, OnGetRoutePlanResultListener {
    // 浏览路线节点相关
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.baidumap1_2);
...
//        }
    ...
    public void nodeClick(View v) {
        ...
        // show popup
        popupText = new TextView(BaiduMap2.this);
...
//    }
    ...
    public void MyToast(String s) {
        Toast.makeText(BaiduMap2.this, s, Toast.LENGTH_SHORT).show();
    }
