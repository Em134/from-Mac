...
public class ActivityResult15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wenzhen_result15);    //急性鼻炎
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                values.put("cure","急性鼻炎");
                db.insert("CureHistory",null,values);
                values.clear();
                Intent intent = null;
                intent = new Intent(ActivityResult15.this, MainActivity.class);
