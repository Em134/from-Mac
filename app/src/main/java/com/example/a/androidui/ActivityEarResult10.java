...
public class ActivityEarResult10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wenzhen_ear_result10); //鼻咽癌
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = null;
                intent = new Intent(ActivityEarResult10.this, MainActivity.class);
