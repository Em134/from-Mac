...
public class ActivityEarResult1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wenzhen_ear_result1); //搏动性耳鸣
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = null;
                intent = new Intent(ActivityEarResult1.this, MainActivity.class);
