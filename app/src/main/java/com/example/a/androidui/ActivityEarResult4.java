...
public class ActivityEarResult4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wenzhen_ear_result4); //耳疗
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = null;
                intent = new Intent(ActivityEarResult4.this, MainActivity.class);
