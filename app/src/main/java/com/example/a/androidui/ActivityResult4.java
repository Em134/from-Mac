...
public class ActivityResult4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wenzhen_result4);
        back1 = (Button) this.findViewById(R.id.coldback1);//慢性咽炎
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                values.clear();
                Intent intent = null;
                intent = new Intent(ActivityResult4.this, MainActivity.class);
