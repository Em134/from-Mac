...
public class ActivityMouthResult19 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wenzhen_mouth_result19);  //口臭
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                values.clear();
                Intent intent = null;
                intent = new Intent(ActivityMouthResult19.this, MainActivity.class);
