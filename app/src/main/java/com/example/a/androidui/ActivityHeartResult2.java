...
public class ActivityHeartResult2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wenzhen_heart_result2);  //心脏病
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = null;
                intent = new Intent(ActivityHeartResult2.this, MainActivity.class);
