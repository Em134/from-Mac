...
public class ActivityEyeResult19 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wenzhen_eye_result19);  //结膜炎
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                values.clear();
                Intent intent = null;
                intent = new Intent(ActivityEyeResult19.this, MainActivity.class);
