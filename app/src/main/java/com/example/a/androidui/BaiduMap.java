...
public class BaiduMap extends Activity {
    ...
    private Button btn_opt;//导航按钮
    private Button btn_loc;//定位按钮
...
private EditText start_edit, end_edit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.baidumap1_1);
    ...
    public View.OnClickListener clickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if(v.getId() == R.id.btn_change){
                if(mBaiduMap.getMapType() == com.baidu.mapapi.map.BaiduMap.MAP_TYPE_NORMAL) {
...
//添加滑动窗口函数，在activity_main.xml中由于添加了NavigationView组件，看书到底是要添加什么依赖。
                ...
                Intent intent = new Intent(BaiduMap.this,CustomerMenu.class);
