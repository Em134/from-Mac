...
public class ActivityCpr extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jiuhu_cpr_result); //CPR
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = null;
                intent = new Intent(ActivityCpr.this, MainActivity.class);
